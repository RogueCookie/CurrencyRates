...
namespace CurrencyRates.Report.Api.Extensions
{
    /// <summary>
    ...
    public static class SwaggerExtension
    {
        ...
        public static void RegisterSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Title = "CurrencyRates report api",
                    Description = "Api of user interaction with the application",
                    Version = "v1",
    ...
    public static class SwaggerUiExtension
    {
        ...
        public static void RegisterSwaggerUi(this IApplicationBuilder app)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "CurrencyRates report v1");
